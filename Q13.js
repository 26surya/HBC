...
const questions = [
    { question: "Which vitamin is produced in the human body when exposed to sunlight?", correct: "A", nextPage: "Q14.html" }
];

let currentQuestion = prizes.length - 13; // Start at ₹1,000 (last index)
