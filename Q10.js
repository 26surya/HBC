...
const questions = [
    { question: "Which of the following is NOT a programming language?", correct: "B", nextPage: "Q11.html" },];

let currentQuestion = prizes.length - 10; // Start at ₹1,000 (last index)
