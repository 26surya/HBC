...
const questions = [
    { question: "Who discovered gravity when an apple fell on his head?", correct: "C", nextPage: "Q10.html" },];

let currentQuestion = prizes.length - 9; // Start at ₹1,000 (last index)
